  ...
  <Fragment>
    <Layout hideFooter>
      ...
      <div className="my-2">
        ...
        <p>
          หยวนโอเปร่าแฟรี่แจ๊ส จิ๊กซอว์ แอ็กชั่นซูชิไฮไลท์วิกแพนงเชิญ ซาตานแคนู
          แจ๊ส แจ็กเก็ตไวกิ้งดิสเครดิตรีวิวมาร์เก็ตติ้ง
          บริกรไฮเวย์เซ็กซี่โปรเจกเตอร์อุปนายิก
        </p>
      </div>
      <div className="my-2">
        <Topic>บุคลิก</Topic>
    ...
    <ReservationContainer>
      <div className="row h-100">
        ...
        <ReservationButton className="col-6">จองเลย</ReservationButton>
      </div>
    </ReservationContainer>
  </Fragment>
);
